...
Hey there casual reader! I’m your **The Mighty Glossary**.
> 	Lingo that enables Great Learning of all crypto related terms under or on [blockchain](https://bitfalls.com/2017/08/20/blockchain-explained-blockchain-works/).
> 
> The path to understanding this convoluted corner of the new reality so you can better understand what we are talking about when talking "Crypto". This content can be found on various sites but we're happy you found it [here](https://bitfalls.com/hr/category/news/). 
...
### **Alt Coins** 
* *Any coin* that is not bitcoin is an alt coin. There is no getting around this. If you are not bitcoin you're ALT, where there is some debate about what you become after you fork out from the original blockchain. So, we have some clones like ETH and ETC, BTC and BCH which were made out of the same blockchain. But the development continues in its own direction afterwards. it is like the Trunk of the tree. It is one to the point where the branches decide to go in its own direction. Some become the part of the tree some wither and die. Don't be a bag holder. :P

### **ASIC** 
* Application Specific Integrated Circuit (ASIC) - is a computer chip created to perform one specific function, and only that function. Since mining of cryptocurrency data [blocks](https://bitfalls.com/2017/08/20/blockchain-explained-blockchain-works/) can demand a lot of computer space and time, some miners set aside entire devices—or partition off a section of their computers—to do nothing but mining. Usually a little brick you can see [here](www.bitmain.com) that you plug into the wall and InternetZ so it can pay you back. 

### **ASA** 
* Asymmetric Key Algorithm - This is the algorithm used to generate public and private keys, the unique codes that are essential to cryptocurrency transactions. - Makes sure you get your Shi* when you send your coins around. See more [here](https://bitfalls.com/2017/08/31/what-cryptocurrency-wallet/).

### **ATH** 
* All time high. Time when panties fly to the stage. This means that the price of a certain cryptocurrency or coin has broken all of its past records and is trading at the highest price it has ever achieved. (usually short lived, just like that stage reference made previously)

## B

### **Bagholder** 
* *One word*. It defines what you will become if you are mildly said, succumb to FOMO and to buy- what you think will be - the next Bitcoin. If you are praying you can get back half of what you put in (you won’t)- you are a bagholder or more simply put - stuck with 1000 horses when the car got adopted as a mean of transportation.
...
### **Blockchain Expert** 
* Anyone who has learned about [Bitcoin]( from a TEDx video and is looking for a VC. xD The people who understand and work with Blockchain are the experts. The rest of us just learning. I mean if you do not know what "multi sig parity client" means, well - just that. UR no expert. kthxbai.
...
### **Bubble** 
* A bubble occurs when a market is driven upward by investors; this has happened in the dot-com and housing industries in the past decade or so. The more of money going in is like you blow more air into the balloon. The normal movement of the balloon is the movement between breaths - that is what you can see on all the graphs - moving up and down. If you blow your balloon into big size and then someone bursts your balloon you end up losing all air inside and it leaves. Bursting can be triggered by news or events. The difference is that balloon is being blown by millions of others at the same time. If you anticipate that the bad news are coming u inhale ur share of the air back and you close your place. U hold your breath until you feel safe to breathe again. :P
...
### **Butthurt** 
* A description of where you will feel the pain when your shitcoin goes to zero.
...
### **Choyna**
* A distortion of “China,” a country that is hugely influential to bitcoin because it’s where the most trading and mining activity occurs. (Bitcoins are “mined” by powerful computers running labor-intensive algorithms).

### **Classic** 
* A common name referred to something that is more than two years old.  Ethereum Classic, Bitcoin Classic etc… In this case developers tend to name the forked coins - Classic - meaning that they stem from the original blockchain and trying to keep the values (what sentimental what practical) or the original idea intact, just further improving it. 

### **Cloud Mining**
* You would like to mine with your own PC. Well unless you have a lot of space and sound insulation this is a choice. But in case you are not willing or you are unable to do this on your own, you can go to some of the companies online who do offer this service. These companies invest in the hardware that allows for high-end mining power, and they in turn lease the access to this mining capability to third parties. As an individual miner, this means you can sign a contract that allows you to use a predetermined amount of mining power through cloud computing, without the hassle. For the individual rules and information on how this operates, you will need to read the FAQ the service of choice.
...
* The amounts of currency given away on faucet sites are quite small, and they offer just enough of a taste to get potential investors interested. Usually when sharks taste blood in the water they are attracted to the source of it. It usually drives traffic and incremental sales through direct and indirect financing. On occasion, either lack of investor interest or shortage of funding will cause a faucet site to shut down; when that happens—in keeping with the terminology—that faucet is said to have *gone dry*.

### **FIAT Currency**
* Main point. Not an Italian car company. Nor the initials of names the [1st Croatian president](https://en.wikipedia.org/wiki/Franjo_Tuđman) and his wife. 
...
* Technical analysis system that can predict crypto price corrections. Also, the amount of money you will lose using this system, is proportional to a [Fibonacci spiral](https://upload.wikimedia.org/wikipedia/commons/2/2e/FibonacciSpiral.svg).
...
### **FOMO**
* The fear of missing out. You see and hear how everyone is buying Lambos and turning their life around. True. But don't buy on the top in FOMO because if the  market turns and you are still holding the bags, you will learn what is to be a POW or your own portfolio. 
...
### **Fork**
* Simply said, this is not a cutlery reference. So, when some Cryptocurrencies grow up they decide split up like an amoeba. The two blockchains are the exact copies at the time of the split or FORK, resulting the people who have the X amount of coin on one blockchain to receive the same amount of the new forged coin on the new created blockchain. After the fork, each coin continues independent development and goes in its own direction, or in the worst-case scenario gets abandoned and disappears. Samples are ETH and ETC, BTC and BCH, etc. 
...
* *The most famous collector’s gold ultimate edition* Genesis block generated was Block 0 of the Bitcoin chain, created by the currency's founder, Satoshi Nakamoto, in January 2009. 
...
>KH/s: Kilo hashes per second, or one thousand hash computations per second
>
>MH/s: Mega hashes per second, or one million hash computations per second
>
>GH/s: Gig hashes per second, or one billion hash computations per second
>
...
* ***NOT THE SHAMPOO*** The head and shoulders pattern forms on a market value chart when two smaller fluctuations in value bracket a larger one in the middle.

![Head and Shoulders Graph](https://upload.wikimedia.org/wikipedia/en/2/2c/H_and_s_top_new.jpg)


### **Hodling**
* Typos can make you famous. On one of the more known [forums](https://bitcointalk.org/index.php?topic=375643.0) HOLD was mistyped and the term was coined as we know it today. It is a meme of constant amusement, because hodling a shitcoin is quite stupid. “HODL” – “Hold on for dear life”
...
* Mining serves a dual purpose; not only does it validate transactions, but it results in the generation of new cryptocurrency. 
...
* As in the games, there are people who will help you level and there will be people who will want to gank you and take your lunch money. N00bZ can be an easy prey as the lack of knowledge makes them easy targets.
...
### **Pennant Pattern**
* This pattern forms on market value charts when investors want to test a current trend in a commodity's value. See more [here](http://www.investopedia.com/university/charts/charts6.asp
...
### **QR Code**
* These are a lot like the rectangular bar codes you'll find on just about anything you buy, except QR codes are square in shape and can hold more information than bar codes. Merchants who accept cryptocurrency as payment—as well as other types of currency—will often display QR codes in their stores. All the customer has to do is scan the QR code with their smartphone, and it will direct them to a URL where they can make the purchase right then and there, without the inconvenience of waiting in line at a cash register. Most digital currency mobile apps include QR code-scanning capability. For example, payment structure in China is based all around payments with your phone. WeChat Pay and AliPay are the majority market and CC and Cash are on the way OUT! Some places reject payment by cash. 
* I'm QR Code:

><a rel='nofollow' href='http://www.qrcode-generator.de' border='0' style='cursor:default'><img src='https://chart.googleapis.com/chart?cht=qr&chl=maax.net%40gmail.com&chs=180x180&choe=UTF-8&chld=L|2' alt=''></a>
>

## R

### **Rekt**
* You discover that you were the last person to ever place an order to buy that shitcoin.
...
### **Shitcoin**
* this is not necessarily a bad term. Traders don’t avoid a coin because it is a shitcoin. I have seen traders rally a coin with a broken [blockchain](https://bitfalls.com/2017/08/20/blockchain-explained-blockchain-works/). Just never fool yourself and start believing in a shitcoin. (Like Dodgecoin).

### **Silk Road**
* This was the notorious online black marketplace where drug deals and money laundering occurred on a regular basis. Many of the transactions on Silk Road used cryptocurrencies, which gave the entire industry a black eye for a while. After a long FBI investigation, Silk Road's owner was arrested in October of 2013, and the entire operation was shut down. (Monero was used as the most untraceable of all Crypto)
...
### **To the moon!**
* A rallying cry for bitcoin’s price to rise sky-high. It has sparked existential questions—”Can we please define ‘moon’?“—and attempts to literally translate the phrase by making cryptocurrencies function in space colonies.
...
### **Trollbox** 
* Is the chat box that sits on the fringes of a trading screen. All that happens on in the Trollbox should be taken with more than just a grain of salt and is what you would generally expect from any chatroom on the internet, populated primarily by teenage to middle aged males, however I would argue that cryptocurrency trollboxes add cash to the mix. Just don't be a N00B. Mkay. KThxBai.
...
### **Whale**
* In finance, a whale is usually a very wealthy investor or institution. In crypto, it can mean a person in your family living in ur basement who borrowed two grand from you the Parent.
