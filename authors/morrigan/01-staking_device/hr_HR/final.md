...
Postoje i druge kriptovalute koje koriste PoS kao što su: QTUM, PIVX, Signatum, Navcoin itd. - mogu se pronaći na [Crypto compare listi](https://www.cryptocompare.com/coins/#/btc) kada odaberete PoS  u koloni "proof type". Nagrade se mogu dobiti i za ostale kriptovalute koje koriste dPoS konsenzus kao ARK ili LISK, ali nagrada se dobiva od delegata za koje se glasa i zbog toga su stvoreni poolovi glasača.
